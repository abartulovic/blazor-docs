    ...
    <div style={{ margin: '1.5rem 0 2rem' }}>
      {(title || description) && (
        <div style={{ marginBottom: '0.85rem' }}>
          ...
          {description ? (
            <p style={{ margin: '0.45rem 0 0', opacity: 0.82 }}>{description}</p>
          ) : null}
        </div>
      )}
      ...
      >
        ...
        >
          ...
          >
            ...
            <code style={{ fontSize: '0.78rem', opacity: 0.8 }}>{fileName}</code>
          </div>
          ...
          {image ? (
            <figure style={{ margin: 0 }}>
              ...
              />
              {(caption || fileName) ? (
                <figcaption style={{ padding: '0.8rem 0.95rem', fontSize: '0.88rem', opacity: 0.85 }}>
                  {caption}
                </figcaption>
              ) : null}
            </figure>
            ...
            <div style={{ padding: '1rem' }}>
              ...
              >
                <div>
                  <div style={{ fontWeight: 700, marginBottom: '0.4rem' }}>Ovdje umetni preview sliku</div>
                  <div style={{ fontSize: '0.92rem', opacity: 0.82, marginBottom: '0.3rem' }}>
                    Naziv datoteke: <code>{fileName}</code>
                  </div>
                  <div style={{ fontSize: '0.85rem', opacity: 0.72 }}>
                    Upload putanja: <code>{uploadPath}{fileName}</code>
                  </div>
                </div>
              </div>
              {(caption || fileName) ? (
                <div style={{ paddingTop: '0.8rem', fontSize: '0.88rem', opacity: 0.85 }}>
                  {caption}
                </div>
              ) : null}
            </div>
